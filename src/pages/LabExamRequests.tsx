        ...
        <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 md:px-6 md:py-10">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between gap-2 p-3 sm:p-6">
              <CardTitle className="text-lg sm:text-2xl truncate">Pedidos de Exames Laboratoriais</CardTitle>
              <Button
                variant="outline"
                    ...
                    <PaginationContent className="gap-0 sm:gap-2">
                      <PaginationItem>
                        <Button
                          ...
                          className="h-6 w-6 sm:h-10 sm:w-10 min-w-[24px] sm:min-w-[40px]"
                        >
                        ...
                        <PaginationItem key={`${page}-${i}`}>
                          {typeof page === 'number' ? (
                            <PaginationLink
                              ...
                              className="cursor-pointer h-6 w-6 sm:h-10 sm:w-10 min-w-[24px] sm:min-w-[40px] text-[10px] sm:text-sm p-0"
                            >
                              {page}
                            </PaginationLink>
                          ) : (
                            <PaginationEllipsis className="h-6 w-6 sm:h-10 sm:w-10 min-w-[24px] sm:min-w-[40px]" />
                          )}
                        </PaginationItem>
                      ))}
