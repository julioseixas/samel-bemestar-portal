          ...
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Conheça todas as unidades da Samel
              </p>
            </div>
          </div>
            ...
            <div ref={cardsRef} className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {units.map((unit) => (
                <div
                  key={unit.id}
                  data-unit-card
                  className="group rounded-xl border border-border bg-card overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md hover:border-primary/30"
                >
                  {/* Imagem */}
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        ...
                        <span className="hidden xs:inline">Ver no Mapa</span>
                      ...
                      {unit.dddTelefone && unit.numeroTelefone && (
                        ...
                        >
                          ...
                          <span className="hidden xs:inline">
                            {formatPhone(unit.dddTelefone, unit.numeroTelefone)}
                          </span>
