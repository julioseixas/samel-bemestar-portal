  ...
  const fetchQueueData = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://api-portalpaciente-web.samel.com.br/api/Agenda/ListarFilaAtendimentoPresencialExame",
        {
          method: "POST",
          headers,
                      ...
                      <CardTitle className="flex items-center justify-between gap-2 text-base sm:text-lg">
                        <div className="flex items-center gap-1.5 sm:gap-2">
                          ...
                          <span className={isCurrentPatient ? "text-primary font-bold" : ""}>
                            Posição #{item.posicaoAtual || index + 1}
                          </span>
                        </div>
                        {isCurrentPatient && (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                          <div className="flex items-start gap-2">
                            ...
                            <div className="min-w-0">
                              <p className="text-xs text-muted-foreground">Horário do Exame</p>
...
export default ExamQueueDetails;