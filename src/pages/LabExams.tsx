...
const LabExams = () => {
  ...
  const fetchProgressExams = async (cdPessoaFisica: string) => {
    ...
    try {
      const response = await fetch(
        `https://api-portalpaciente-web.samel.com.br/api/progressaoLaboratorial/buscarExamesLabPaciente?cd_pessoa_fisica=${cdPessoaFisica}`,
        {
          method: "GET",
          headers: {
  ...
  const fetchExamProgression = async (cdPessoaFisica: string, nrSeqExame: number) => {
    ...
    try {
      const response = await fetch(
        `https://api-portalpaciente-web.samel.com.br/api/progressaoLaboratorial/buscarProgressaoExames?cd_pessoa_fisica=${cdPessoaFisica}&nr_seq_exame=${nrSeqExame}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
