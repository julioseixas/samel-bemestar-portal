    ...
    return (
      <>
        <button
          ...
          className="mb-4 w-full flex items-center justify-between gap-2 px-4 py-3 rounded-lg border border-primary/20 bg-primary/5 hover:bg-primary/10 transition-colors text-left"
        >
          <span className="flex items-center gap-2 text-sm font-medium text-foreground">
            <HelpCircle className="h-4 w-4 text-primary flex-shrink-0" />
            Como usar a Telemedicina
          </span>
          <span className="text-muted-foreground text-xs">Ver instruções →</span>
        </button>

        <Dialog open={helpOpen} onOpenChange={setHelpOpen}>
          <DialogContent className="max-w-[calc(100vw-1.5rem)] sm:max-w-lg max-h-[calc(100vh-1.5rem)] flex flex-col p-0">
