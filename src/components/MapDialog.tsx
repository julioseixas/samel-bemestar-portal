...
export const MapDialog = ({ open, onOpenChange, location, unitName }: MapDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[calc(100vw-1.5rem)] sm:max-w-[95vw] w-full h-[75vh] sm:h-[80vh] flex flex-col p-0">
        <DialogHeader className="px-3 py-3 sm:px-6 sm:py-4 border-b bg-card shrink-0">
          <DialogTitle className="text-sm sm:text-base text-left">
        ...
        <div className="shrink-0 px-2 py-2 sm:px-6 sm:py-4 border-t bg-card">
          <div className="flex flex-col sm:flex-row sm:justify-between gap-1.5 sm:gap-2">
            <div className="flex flex-col xs:flex-row gap-1.5 sm:gap-2 w-full sm:w-auto">
              <Button
                variant="outline"
